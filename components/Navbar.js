...
const pages = [{name: 'Home', path: ''}, {name: 'Packages', path: 'packages'}, {name: 'Services', path: 'services'}, {name: 'Meet Jade', path: 'meet-jade'}, {name: 'Events', path: 'events'}, {name: 'Contact', path: 'contact'}];
